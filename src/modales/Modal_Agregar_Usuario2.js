...
const Modal_Agregar_Usuario2 = ({show, handleClose1}) =>{
  ...
  return (
      ...
      <Modal show={show} onHide={handleClose1}>
        ...
        <Modal.Footer>
          <Button variant="danger" onClick={handleClose1}>Cancelar</Button>
          <Button variant="success" onClick={handleClose1}>Registrar</Button>
        </Modal.Footer>
      </Modal>
...
export default Modal_Agregar_Usuario2